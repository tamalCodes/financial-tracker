...
| **Landing page** — public Kharcha marketing page at `/landing`; premium warm editorial story, original CSS product preview, supplied 3D freedom-art CTA and footer | `features/landing.md` | `src/app/landing/{page.tsx,LandingMotion.tsx,landing.module.css}`, `public/landing/{freedom.jpg,freedom-cutout.png,testimonial-{meera,aarav,riya}.png}`, `package.json`, `src/app/{layout,globals}.css` |
