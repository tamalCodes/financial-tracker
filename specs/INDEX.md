...
| **Landing page** — public Kharcha marketing page at `/`; `/auth` CTA routing; sitemap + robots metadata; premium warm editorial story, responsive phone/tablet scroll-sheet parallax with diagonal portrait proof cards, fully framed freedom artwork, and adaptive footer information architecture | `features/landing.md` | `src/app/{page,sitemap,robots}.ts(x)`, `src/app/landing/{page.tsx,LandingMotion.tsx,StoryRotator.tsx,landing.module.css}`, `public/landing/{freedom.jpg,freedom-cutout.png,testimonial-{meera,aarav,riya}.png}`, `.env.example`, `package.json`, `src/app/{layout,globals}.css` |
