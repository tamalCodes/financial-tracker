...
| **Landing page** — public Kharcha marketing page at `/`; `/auth` CTA routing; sitemap + robots metadata; centred cloud-film hero with Kharcha phone artwork, premium warm editorial story, responsive phone/tablet scroll-sheet parallax, fully framed freedom artwork, and adaptive footer information architecture | `features/landing.md` | `src/app/{page,sitemap,robots}.ts(x)`, `src/app/landing/{page.tsx,LandingMotion.tsx,StoryRotator.tsx,landing.module.css}`, `public/landing/{hero-clouds-gold.webm,hero-clouds-gold.mp4,hero-clouds-gold-mobile.webm,hero-clouds-gold-mobile.mp4,hero-clouds-gold-poster.avif,hero-phone-hand-v4.png,freedom.jpg,freedom-cutout.png,testimonial-{meera,aarav,riya}.png}`, `.env.example`, `package.json`, `src/app/{layout,globals}.css` |
