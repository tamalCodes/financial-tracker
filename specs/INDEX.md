...
| **Landing page** — public Kharcha marketing page at `/`; `/auth` CTA routing; sitemap + robots metadata; centred static Luminous Ledger hero with an immediate three-metric monthly pulse, natural phone-in-hand balance proof and supporting Spending/Investments screens, premium warm editorial story, responsive phone/tablet scroll-sheet parallax, fully framed freedom artwork, and adaptive footer information architecture | `features/landing.md` | `src/app/{page,sitemap,robots}.ts(x)`, `src/app/landing/{page.tsx,HeroPhone.tsx,LandingMotion.tsx,StoryRotator.tsx,landing.module.css}`, `public/landing/{hero-phone-hand-v5.png,freedom.jpg,freedom-cutout.png,testimonial-{meera,aarav,riya}.png}`, `.env.example`, `package.json`, `src/app/{layout,globals}.css` |
