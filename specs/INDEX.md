...
| **Landing page** — public Kharcha marketing page at `/landing`; premium warm editorial story, original CSS product preview, CTA and footer | `features/landing.md` | `src/app/landing/{page.tsx,landing.module.css}`, `src/app/{layout,globals}.css` |
