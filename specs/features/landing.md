...
- The dark product chapter uses two bounded GSAP sheet transitions: it enters as a softly rounded sheet over the preceding cream section, then the existing cream customer-story sheet rises edge-to-edge over its tail using full-width vertical translation only. The light sheet never scales, clips or rotates, preventing dark gutters around its square boundary. There is no extra handoff chapter, sticky hold, WebGL plane or internal testimonial parallax. The closing dark CTA stays in normal document flow so its boundary remains stable. Reduced-motion visitors receive static layers, and mobile keeps short translation-only motion.
